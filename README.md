...
```mermaid
flowchart LR
  T1["Блок 1: Аналитическое решение"]
  T1 --> T1a["<a href='Задание_1_Графы_и_таблицы/'>№1: Графы и таблицы</a>"]
  T1 --> T1b["<a href='Задание_4_Кодирование_Фано/'>№4: Кодирование. Условие Фано</a>"]
  T1 --> T1c["<a href='Задание_7_Кодирование_информации/'>№7: Кодирование изображений и звука</a>"]
  T1 --> T1d["<a href='Задание_11_Объем_памяти_кодирование/'>№11: Информационный объём</a>"]
  T1 --> T1e["№12: Алгоритмы для строк (Редактор)"]

  click T1a "Задание_1_Графы_и_таблицы/"
  click T1b "Задание_4_Кодирование_Фано/"
  click T1c "Задание_7_Кодирование_информации/"
...
```mermaid
flowchart LR
  T2["Блок 2: Python база"]
  T2 --> T2a["<a href='Задание_2_Таблицы_истинности/'>№2: Таблицы истинности</a>"]
  T2 --> T2b["№5: Анализ алгоритмов. Исполнитель"]
  T2 --> T2c["№6: Исполнитель «Черепашка»"]
  T2 --> T2d["<a href='Задание_8_Комбинаторика/'>№8: Комбинаторика</a>"]
  T2 --> T2e["№13: IP-адресация и сети"]
  T2 --> T2f["<a href='Задание_14_Системы_счисления/'>№14: Системы счисления</a>"]
  T2 --> T2g["<a href='Задание_15_Логические_выражения/'>№15: Логические выражения (отрезки/множества)</a>"]

  click T2a "Задание_2_Таблицы_истинности/"
  click T2d "Задание_8_Комбинаторика/"
  click T2f "Задание_14_Системы_счисления/"
...
```mermaid
flowchart LR
  T3["Блок 3: Офисные приложения"]
  T3 --> T3a["<a href='Задание_3_Поиск_БД/'>№3: Поиск в базах данных (Excel)</a>"]
  T3 --> T3b["<a href='Задание_9_Электронные_таблицы/'>№9: Электронные таблицы (Excel)</a>"]
  T3 --> T3c["<a href='Задание_10_Обработка_текстовой_информации/'>№10: Поиск текста в документах (Word)</a>"]
  T3 --> T3d["<a href='Задание_18_Робот_сборщик_монет/'>№18: Робот-сборщик монет (Excel)</a>"]
  T3 --> T3e["<a href='Задание_22_Вычислительные_процессы/'>№22: Параллельные процессы (Excel)</a>"]

  click T3a "Задание_3_Поиск_БД/"
  click T3b "Задание_9_Электронные_таблицы/"
  click T3c "Задание_10_Обработка_текстовой_информации/"
  click T3d "Задание_18_Робот_сборщик_монет/"
...
```mermaid
flowchart LR
  T6["Блок 6: Python продвинутые алгоритмы"]
