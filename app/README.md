...
URL: https://scharfff.github.io/spbpu-inf-course/
...
1. Добавить папку `Задание_N_...` с `README.md` и `Решение/*.py` в корень репозитория.
2. При необходимости обновить `data/taxonomy.json`.
3. Запустить `npm run index` или `npm run build`.
